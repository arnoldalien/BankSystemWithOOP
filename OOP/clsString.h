...
public:
    ...
    enum enWhatCount { SmallLetters = 1, CapitalLetters = 2, All = 3 };

    static int CountLetters(string S1, enWhatCount WhatCount = enWhatCount::All)
    {
        int Counter = 0;
    ...
    short CountSpecificLetter(char Letter, bool MathCase = true)
    {
        return CountSpecificLetter(_Value, Letter, MathCase);
    }
